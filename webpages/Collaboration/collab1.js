    ...
    <div id="collab-card-container">
      <div className="card">
        <div className="card-body">
          <img src="/Assets/images/demo.png" alt className="holding-img" />
    ...
    <div id="text-spam">
      <div id="collaborators-access-card">
        <div className="card text-center">
          <div className="card-body">
            ...
            <p className="card-text">
              Click the button below to view all the coders
              working on the project
            </p>
            <a href="#" className="btn btn-secondary" onclick="displayCollaborators();">View Collaborators</a>
          </div>
        </div>
      </div>
      <div id="collaborators-view">
        ...
        <h5 style={{paddingBottom: 30}}>
          Here are all the active coders working on this sproject
        </h5>
